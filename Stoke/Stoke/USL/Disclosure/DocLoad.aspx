<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocLoad.aspx.cs" Inherits="Stoke.USL.Disclosure.DocLoad" %>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="aa03">
                                                                        下载模板列表</td>
                                                                    <td width="120">
                                                                     <%--<img height="16" src="../../images/ico_04.gif" width="17" align="absmiddle"><a href="DocUpload.aspx">
                                                                            添加模板</a>--%>
                                                                    </td>
                                                                        ...
                                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 20%; height: 25px; text-align: left;">
                                                                                    <asp:TextBox ID="DocName" runat="server" Width="100%"></asp:TextBox></td>
                                                                                ...
                                                                                <td style="width: 25%; height: 25px; text-align: left;">
                                                                                    <asp:TextBox ID="DocDesc" runat="server" Width="100%"></asp:TextBox></td>
                                                                                ...
                                                                                <td style="height: 15px" colspan="8" align="right">
                                                                                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:BoundField DataField="DocName" HeaderText="模板名称">
                                                                                                <ItemStyle Width="30%" />
                                                                                            </asp:BoundField>
                                                                                            <asp:BoundField DataField="DocDesc" HeaderText="模板描述">
                                                                                            </asp:BoundField>
                                                                                            <asp:BoundField DataField="DocDate" HeaderText="上传时间">
                                                                                            <ItemStyle Width="14%" />
                                                                                            </asp:BoundField>
                                                                                            <asp:BoundField DataField="DocRealName" HeaderText="模板真实名称" Visible="false">
                                                                                            </asp:BoundField>
                                                                                            <asp:TemplateField HeaderText="操作">
                                                                                                <ItemTemplate>
                                                                                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "DownLoad.aspx?realname="+Eval("DocRealName") %>'
                                                                                            ...
                                                                                            <asp:TemplateField HeaderText="删除">
                                                                                                <ItemTemplate>
                                                                                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../../images/delete.png"
                                                                                                        CommandName="Delete" OnClientClick="return confirm('您确定要删除此模板?')" CausesValidation="False"
