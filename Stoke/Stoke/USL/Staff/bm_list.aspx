<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bm_list.aspx.cs" Inherits="Stoke.USL.Staff.bm_list" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			height=24><asp:linkbutton id="lbXmz" runat="server" CssClass="Newbutton" ForeColor="White">项目组</asp:linkbutton></TD>
								<TD align="right"><FONT face="宋体">
										<asp:button id="Button1" runat="server" Text="添加部门/项目组"  CssClass="input4"
							Width="100px"></asp:button>
										<asp:Button id="btn_ysc" runat="server" CssClass="input4" Text="已撤销"></asp:Button>&nbsp;</FONT></TD>
							</TR>
						</TABLE>
					</TD>
				</tr>
					...
					<TD class="td2" vAlign="baseline" align="center" style="HEIGHT: 330px">
						...
						<HeaderStyle BackColor="#507CD1" ForeColor="white" Font-Bold="true" HorizontalAlign="Center"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="bm_kgmlh" HeaderText="缩写/开工命令号" Visible="false">
									<HeaderStyle Width="10%"></HeaderStyle>
								</asp:BoundColumn>
								<asp:TemplateColumn HeaderText="功能">
									...
									<ItemTemplate>
										...
										<asp:LinkButton id="LinkButton2" runat="server" CommandName="delete">撤销</asp:LinkButton>&nbsp;
										<asp:LinkButton id="LinkButton3" runat="server" CommandName="sc">删除</asp:LinkButton>
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
