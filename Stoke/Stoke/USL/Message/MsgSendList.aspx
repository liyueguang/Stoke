<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MsgSendList.aspx.cs" Inherits="Stoke.USL.Message.MsgSendList" %>
                                                                            ...
                                                                            <td style="height: 15px" colspan="13" align="right">
                                                                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="MsgReceive" HeaderText="接收人">
                                                                                            <ItemStyle Width="20%" />
                                                                                        </asp:BoundField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="操作">
                                                                                            <ItemTemplate>
                                                                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "MsgSend.aspx?ID="+Eval("ID") %>'
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="查看">
                                                                                            <ItemTemplate>
                                                                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "MsgView.aspx?flag=0&ID="+Eval("ID") %>'
