...
{
    public partial class ccsq_Next_Step : System.Web.UI.Page
    {
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (_remark == 1 || _remark == 3) //添加部门自动绑定的会签处理问题-------ws/20100712
                {
                    ...
                    SaveProc();
                    Response.Redirect("../workflow/Work_Manage.aspx?zgbh=" + _zgbh); //跳转到待办hhw20101105
                }
                else
                {
                    conn.Open();
        ...
        private void Button2_Click(object sender, System.EventArgs e)
        {
            ...
            if (_step_remark == "0")
            {
                if (_next_step != "-1")
                {
                    if (obj.Text != "无" && obj.Text != string.Empty)
                    {
                        ...
                        conn.Close();
                        SaveProc();
                        Response.Redirect("../workflow/Work_Manage.aspx?zgbh=" + _zgbh); //hhw20101105,跳转到待办
                    }
                    else
            ...
            else
            {
                ...
                conn.Close();
                SaveProc();
                Response.Redirect("../workflow/Work_Manage.aspx?zgbh=" + _zgbh); //hhw20101105跳转到待办
            }
        }
