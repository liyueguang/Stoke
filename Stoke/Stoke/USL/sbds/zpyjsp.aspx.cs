...
namespace Stoke.USL.sbds
{
    public partial class zpyjsp : System.Web.UI.Page
    {
        ...
        private static int flow_id = 32;//该文档所属流程号
        private int FieldNum = 0;//该流程所绑定字段总数
            ...
            if (!Page.IsPostBack)
            {
                ...
                switch (step_id)
                {
                    ...
                    case 1:
                        ...
                        this.h1.Visible = true;//限额hhw20101110
                        this.k1.Visible = true;//限额
                        this.m1.Visible = true;//限额
                        this.o1.Visible = true;//限额
                        this.j1.Visible = false;//限label不显示hhw20101110
                        this.l1.Visible = false;//限
                        this.n1.Visible = false;//限
                        this.p1.Visible = false;//限
                        this.b.Enabled = true;
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        this.d1.Text = UserName;// 经办人hhw20101029
        ...
        private void Step_Handle_Data()
        {
            ...
            this.d.Text = dt_style_data.Rows[0]["d"].ToString() != null ? dt_style_data.Rows[0]["d"].ToString() : null;	//借款金额
            if (dt_style_data.Rows[0]["h1"].ToString() == "True")//限额标志hhw20101110
            {
                this.j1.Text = "限";
            }
            ...
            this.d1.Text = dt_style_data.Rows[0]["d1"].ToString() != null ? dt_style_data.Rows[0]["d1"].ToString() : null; //出纳人hhw20101029
        ...
        public void SaveData()
        {
            ...
            if (bEditMode == false)
            {
                ...
                doc_id = df.AddDocument(_zgbh, flow_id, mySql, this.a.SelectedItem.Text.ToString().Trim() + "支票预借审批单");//删除感叹号hhw20101103
                df = null;
            }
            else
            {
        ...
        private string GetControlText(string field_name)
        {
            ...
            switch (StyleControl.GetType().ToString())
            {
                ...
                case "System.Web.UI.WebControls.CheckBox": //复选框hhw20101110限额标志
        ...
        private void f_TextChanged(object sender, System.EventArgs e)
        {
            ...
            if (this.f.Text != string.Empty)
            {
                ...
                else
                {
                    ...
                    if (!moneyReg.IsMatch(this.f.Text.ToString()))
                    {
                        Response.Write("<script>alert('请保证报销金额必须为整数或类如100.00的浮点数！');</script>");
                        return;
                    }
                }
            }
