<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ccsq_Next_Step.aspx.cs" Inherits="Stoke.USL.sbds.ccsq_Next_Step" %>
			...
			<TABLE style="Z-INDEX: 102; POSITION: absolute; WIDTH: 728px; HEIGHT: 80px; TOP: 40px; LEFT: 8px"
				...
				<TR>
					<TD style="WIDTH: 717px; HEIGHT: 61px">
						<fieldset style="WIDTH: 716px; HEIGHT: 8px" id="fieldset1" runat="server"><LEGEND>请选择下一步骤</LEGEND><asp:radiobuttonlist id="RadioButtonList1" runat="server" AutoPostBack="True" Height="8px"></asp:radiobuttonlist></fieldset>
					</TD>
				</TR>
				<TR>
					<TD>
								...
								<TR id="returnTr" runat="server">
									<TD style="WIDTH: 100%" vAlign="middle" align="center">
										<TABLE id="Table4" border="0" cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												<TD vAlign="middle" width="15%" align="right">填写退回意见：</TD>
												<TD><asp:textbox id="tsyj" runat="server" Height="80px" Width="100%" TextMode="MultiLine" Font-Size="X-Small"
